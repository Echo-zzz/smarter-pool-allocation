; ModuleID = 'candidate-analysis/test/inputs/mixed_nested.c'
source_filename = "candidate-analysis/test/inputs/mixed_nested.c"
...
define i32 @mixed_process(i64 noundef %0) #0 {
...
define i32 @main() #0 {
  ...
  %2 = call i32 @mixed_process(i64 noundef 10)
  ret i32 %2
}
